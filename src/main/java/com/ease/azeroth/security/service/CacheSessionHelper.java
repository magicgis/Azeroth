...
import com.ease.azeroth.security.session.SessionHelper;
...
/**
 * Created by fumanix on 2/26/16.
 */
public class CacheSessionHelper extends EnterpriseCacheSessionDAO implements SessionHelper {

    private static final Logger logger = LogManager.getLogger(LogManager.ROOT_LOGGER_NAME);

    public CacheSessionHelper() {
        super();
    }
